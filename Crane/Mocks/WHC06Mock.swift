                ...
                data: [
                    ...
                    CBMAdvertisementDataManufacturerDataKey: Data(
                        [
                            ...
                            0x11,
                            0x23, 0xe1, 0x01,
                        ] + withUnsafeBytes(of: Int16(Double.random(in: 0...20) * 100).bigEndian) { Array($0)} + [
                            0x01, 0xf4, 0x01, 0xd4,
                            0xcb,
                        ]
                    ),
...
let WHC06Mock = CBMPeripheralSpec.simulatePeripheral().advertising(
    advertisementData: [
        ...
        CBMAdvertisementDataIsConnectable: true as NSNumber,
        CBMAdvertisementDataManufacturerDataKey: Data([
            0x00, 0x01, 0x02, 0x03, 0x11, 0x2a, 0xc0, 0x19, 0x11, 0x23, 0xe1,
            0x01, 0x00, 0x00, 0x01, 0xf4, 0x01, 0xd4, 0xcb,
